        ...
        <div class="board"> <!-- <h2>Welcome to IGHALO!<sup>™</sup></h2>--> 
            <div class="board-inner"> 
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    </li> <li class="active"><a href="#failed" data-toggle="tab" title="Completed"> <span class="round-tabs five"> <i class="fa fa-times" aria-hidden="true"></i> </span> </a> </li>
                </ul>
            </div>
            <div class="tab-content">
				...
				<div class="tab-pane fade in active" id="failed"> 
					...
					<h3 class="head1 text-center"> <div class="messagecontainer">
					<?php
						$status=$_POST["status"];
						...
						$email=$_POST["email"];
						$salt="GQs7yium";
						echo "<h3><div class='alert alert-danger'>Your order status is ". $status .".</div></h3>";
						echo "<h4>Your transaction id for this transaction is <span class=\"label label-warning\">".$txnid."</span>. You may try again.</h4>";
