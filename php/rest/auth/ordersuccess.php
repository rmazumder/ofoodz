        ...
        <div class="board"> <!-- <h2>Welcome to IGHALO!<sup>™</sup></h2>--> 
            ...
            <div class="tab-content">
				...
				<div class="tab-pane fade in active" id="doner"> 
					...
					<span id="wait">Please wait, we are processing your request.<img src="../../../img/spinner.gif"></span>
					<?php
								include 'user.php';
								include 'DBclass.php';
								...
								echo "<script>document.getElementById(\"wait\").style.display = 'none';</script>";
								   ...
								   if ($hash != $posted_hash) {
									   ...
									   $userObj->updateOrder(array("updatedby"=>'payumoney' ,"email"=>$email, "amountpaid"=>$amount,  "isactive"=>1,  "order_id"=>substr($txnid,17)));
